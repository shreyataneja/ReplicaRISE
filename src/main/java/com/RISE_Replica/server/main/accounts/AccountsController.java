package com.RISE_Replica.server.main.accounts;
...
public class AccountsController {
	...
	{
	JSONObject accounts =	service.getAccounts();
	...
	if (x==200)
	return "Status = 200 : Account Updated";  
	...
	if (x==200)
	return "Status = 200 : Account Deleted";  
